...
export const margin = ({
  ...
  return classes({
    [styles[`marginTop${MARGIN[curentMarginTop || DEFAULT_CSS]}`]]:
      !!curentMarginTop,
    [styles[`marginBottom${MARGIN[curentMarginBottom || DEFAULT_CSS]}`]]:
      !!curentMarginBottom,
    [styles[`marginLeft${MARGIN[curentMarginLeft || DEFAULT_CSS]}`]]:
      !!curentMarginLeft,
    [styles[`marginRight${MARGIN[curentMarginRight || DEFAULT_CSS]}`]]:
      !!curentMarginRight,
  });
};
